...
ENV_DATA_DIR = 'LDP_DATA_DIR'
ENV_RESULTS_DIR = 'LDP_RESULTS_DIR'
...
def data_dir(default: PathLike = DEFAULT_DATA_DIR) -> pathlib.Path:
    ...
    Args:
        default (PathLike, optional): Default to use if LDP_DATA_DIR env
...
def results_dir(default: PathLike = DEFAULT_RESULTS_DIR) -> pathlib.Path:
    ...
    Args:
        default (PathLike, optional): Default to use if LDP_RESULTS_DIR env
